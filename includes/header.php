...
<head>
    ...
    <title>Home | Jehovah Jireh Orphanage | Motherless Babies Home in Nigeria | Care for the less priviledged</title>
    <!-- web-fonts -->
...
<nav class="navbar m-menu navbar-default">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php"><img src="img/logon.png" alt=""></a>
        </div>
